                         ...
                         int compressionLevel)
{
    ...
    assert(cctx != NULL);
    // !!TODO!!: restore to below line after finishing debugging
    // return ZSTD_compress_usingDict(cctx, dst, dstCapacity, src, srcSize, NULL, 0, compressionLevel);
    size_t value =  ZSTD_compress_usingDict(cctx, dst, dstCapacity, src, srcSize, NULL, 0, compressionLevel);
    printf("!! return value from ZSTD_compress_usingDict (yay printf debugging .. jfc this is my life now): value=%d\n", value);
    return value;
}
                     ...
                     int compressionLevel)
{
    ...
    // !!TODO!!: restore to below line after finishing debugging
    // return result;
    printf("!! return value from ZSTD_compress (yay printf debugging .. jfc this is my life now): result=%d\n", result);
    return result;
}
