...
#ifndef PROTOBUF_C_otlp_5fmetrics_2eproto__INCLUDED
#define PROTOBUF_C_otlp_5fmetrics_2eproto__INCLUDED
...
typedef struct _Opentelemetry__Proto__Metrics__V1__MetricsData Opentelemetry__Proto__Metrics__V1__MetricsData;
typedef struct _Opentelemetry__Proto__Metrics__V1__ResourceMetrics Opentelemetry__Proto__Metrics__V1__ResourceMetrics;
typedef struct _Opentelemetry__Proto__Metrics__V1__InstrumentationLibraryMetrics Opentelemetry__Proto__Metrics__V1__InstrumentationLibraryMetrics;
typedef struct _Opentelemetry__Proto__Metrics__V1__Metric Opentelemetry__Proto__Metrics__V1__Metric;
typedef struct _Opentelemetry__Proto__Metrics__V1__Gauge Opentelemetry__Proto__Metrics__V1__Gauge;
typedef struct _Opentelemetry__Proto__Metrics__V1__Sum Opentelemetry__Proto__Metrics__V1__Sum;
typedef struct _Opentelemetry__Proto__Metrics__V1__Histogram Opentelemetry__Proto__Metrics__V1__Histogram;
typedef struct _Opentelemetry__Proto__Metrics__V1__ExponentialHistogram Opentelemetry__Proto__Metrics__V1__ExponentialHistogram;
typedef struct _Opentelemetry__Proto__Metrics__V1__Summary Opentelemetry__Proto__Metrics__V1__Summary;
typedef struct _Opentelemetry__Proto__Metrics__V1__NumberDataPoint Opentelemetry__Proto__Metrics__V1__NumberDataPoint;
typedef struct _Opentelemetry__Proto__Metrics__V1__HistogramDataPoint Opentelemetry__Proto__Metrics__V1__HistogramDataPoint;
typedef struct _Opentelemetry__Proto__Metrics__V1__ExponentialHistogramDataPoint Opentelemetry__Proto__Metrics__V1__ExponentialHistogramDataPoint;
typedef struct _Opentelemetry__Proto__Metrics__V1__ExponentialHistogramDataPoint__Buckets Opentelemetry__Proto__Metrics__V1__ExponentialHistogramDataPoint__Buckets;
typedef struct _Opentelemetry__Proto__Metrics__V1__SummaryDataPoint Opentelemetry__Proto__Metrics__V1__SummaryDataPoint;
typedef struct _Opentelemetry__Proto__Metrics__V1__SummaryDataPoint__ValueAtQuantile Opentelemetry__Proto__Metrics__V1__SummaryDataPoint__ValueAtQuantile;
typedef struct _Opentelemetry__Proto__Metrics__V1__Exemplar Opentelemetry__Proto__Metrics__V1__Exemplar;
 ...
 * as well.
 */
struct  _Opentelemetry__Proto__Metrics__V1__MetricsData
{
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__ResourceMetrics
{
  ProtobufCMessage base;
  /*
   ...
   */
  size_t n_instrumentation_library_metrics;
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__InstrumentationLibraryMetrics
{
  ProtobufCMessage base;
  /*
...
#define OPENTELEMETRY__PROTO__METRICS__V1__INSTRUMENTATION_LIBRARY_METRICS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&opentelemetry__proto__metrics__v1__instrumentation_library_metrics__descriptor) \
    , NULL, 0,NULL, (char *)protobuf_c_empty_string }
...
typedef enum {
  ...
  OPENTELEMETRY__PROTO__METRICS__V1__METRIC__DATA_SUMMARY = 11
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(OPENTELEMETRY__PROTO__METRICS__V1__METRIC__DATA)
 ...
 * strongly encouraged.
 */
struct  _Opentelemetry__Proto__Metrics__V1__Metric
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__Gauge
{
  ProtobufCMessage base;
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__Sum
{
  ProtobufCMessage base;
  size_t n_data_points;
  Opentelemetry__Proto__Metrics__V1__NumberDataPoint **data_points;
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__Histogram
{
  ProtobufCMessage base;
  size_t n_data_points;
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__ExponentialHistogram
{
  ProtobufCMessage base;
  size_t n_data_points;
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__Summary
{
  ProtobufCMessage base;
  size_t n_data_points;
...
typedef enum {
  ...
  OPENTELEMETRY__PROTO__METRICS__V1__NUMBER_DATA_POINT__VALUE_AS_INT = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(OPENTELEMETRY__PROTO__METRICS__V1__NUMBER_DATA_POINT__VALUE)
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__NumberDataPoint
{
  ProtobufCMessage base;
  /*
 ...
 * "sum" are known.
 */
struct  _Opentelemetry__Proto__Metrics__V1__HistogramDataPoint
{
  ProtobufCMessage base;
  /*
   * The set of key/value pairs that uniquely identify the timeseries from
...
#define OPENTELEMETRY__PROTO__METRICS__V1__HISTOGRAM_DATA_POINT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&opentelemetry__proto__metrics__v1__histogram_data_point__descriptor) \
    , 0,NULL, 0, 0, 0, 0, 0,NULL, 0,NULL, 0,NULL, 0 }
 ...
 * of counts.
 */
struct  _Opentelemetry__Proto__Metrics__V1__ExponentialHistogramDataPoint__Buckets
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__ExponentialHistogramDataPoint
{
  ProtobufCMessage base;
  /*
   * The set of key/value pairs that uniquely identify the timeseries from
...
#define OPENTELEMETRY__PROTO__METRICS__V1__EXPONENTIAL_HISTOGRAM_DATA_POINT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&opentelemetry__proto__metrics__v1__exponential_histogram_data_point__descriptor) \
    , 0,NULL, 0, 0, 0, 0, 0, 0, NULL, NULL, 0, 0,NULL }
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__SummaryDataPoint__ValueAtQuantile
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__SummaryDataPoint
{
  ProtobufCMessage base;
  /*
   * The set of key/value pairs that uniquely identify the timeseries from
...
typedef enum {
  ...
  OPENTELEMETRY__PROTO__METRICS__V1__EXEMPLAR__VALUE_AS_INT = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(OPENTELEMETRY__PROTO__METRICS__V1__EXEMPLAR__VALUE)
 ...
 */
struct  _Opentelemetry__Proto__Metrics__V1__Exemplar
{
  ProtobufCMessage base;
  /*
...
void   opentelemetry__proto__metrics__v1__resource_metrics__free_unpacked
                     (Opentelemetry__Proto__Metrics__V1__ResourceMetrics *message,
                      ProtobufCAllocator *allocator);
/* Opentelemetry__Proto__Metrics__V1__InstrumentationLibraryMetrics methods */
...
typedef void (*Opentelemetry__Proto__Metrics__V1__ResourceMetrics_Closure)
                 (const Opentelemetry__Proto__Metrics__V1__ResourceMetrics *message,
                  void *closure_data);
typedef void (*Opentelemetry__Proto__Metrics__V1__InstrumentationLibraryMetrics_Closure)
                 (const Opentelemetry__Proto__Metrics__V1__InstrumentationLibraryMetrics *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor opentelemetry__proto__metrics__v1__instrumentation_library_metrics__descriptor;
...
#endif  /* PROTOBUF_C_otlp_5fmetrics_2eproto__INCLUDED */
