...
typedef struct _Opentelemetry__Proto__Common__V1__AnyValue Opentelemetry__Proto__Common__V1__AnyValue;
typedef struct _Opentelemetry__Proto__Common__V1__ArrayValue Opentelemetry__Proto__Common__V1__ArrayValue;
typedef struct _Opentelemetry__Proto__Common__V1__KeyValueList Opentelemetry__Proto__Common__V1__KeyValueList;
typedef struct _Opentelemetry__Proto__Common__V1__KeyValue Opentelemetry__Proto__Common__V1__KeyValue;
typedef struct _Opentelemetry__Proto__Common__V1__StringKeyValue Opentelemetry__Proto__Common__V1__StringKeyValue;
typedef struct _Opentelemetry__Proto__Common__V1__InstrumentationLibrary Opentelemetry__Proto__Common__V1__InstrumentationLibrary;
...
typedef enum {
  ...
  OPENTELEMETRY__PROTO__COMMON__V1__ANY_VALUE__VALUE_BYTES_VALUE = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(OPENTELEMETRY__PROTO__COMMON__V1__ANY_VALUE__VALUE)
 ...
 */
struct  _Opentelemetry__Proto__Common__V1__AnyValue
{
 ...
 */
struct  _Opentelemetry__Proto__Common__V1__ArrayValue
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _Opentelemetry__Proto__Common__V1__KeyValueList
{
  ProtobufCMessage base;
  /*
 ...
 * attributes, etc.
 */
struct  _Opentelemetry__Proto__Common__V1__KeyValue
{
  ProtobufCMessage base;
  char *key;
 ...
 */
struct  _Opentelemetry__Proto__Common__V1__StringKeyValue
{
  ProtobufCMessage base;
  char *key;
  char *value;
};
#define OPENTELEMETRY__PROTO__COMMON__V1__STRING_KEY_VALUE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&opentelemetry__proto__common__v1__string_key_value__descriptor) \
 ...
 */
struct  _Opentelemetry__Proto__Common__V1__InstrumentationLibrary
{
  ProtobufCMessage base;
  /*
...
#define OPENTELEMETRY__PROTO__COMMON__V1__INSTRUMENTATION_LIBRARY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&opentelemetry__proto__common__v1__instrumentation_library__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string }
...
void   opentelemetry__proto__common__v1__key_value__free_unpacked
                     (Opentelemetry__Proto__Common__V1__KeyValue *message,
                      ProtobufCAllocator *allocator);
/* Opentelemetry__Proto__Common__V1__StringKeyValue methods */
...
void   opentelemetry__proto__common__v1__string_key_value__free_unpacked
                     (Opentelemetry__Proto__Common__V1__StringKeyValue *message,
                      ProtobufCAllocator *allocator);
/* Opentelemetry__Proto__Common__V1__InstrumentationLibrary methods */
...
typedef void (*Opentelemetry__Proto__Common__V1__KeyValue_Closure)
                 (const Opentelemetry__Proto__Common__V1__KeyValue *message,
                  void *closure_data);
typedef void (*Opentelemetry__Proto__Common__V1__StringKeyValue_Closure)
                 (const Opentelemetry__Proto__Common__V1__StringKeyValue *message,
                  void *closure_data);
typedef void (*Opentelemetry__Proto__Common__V1__InstrumentationLibrary_Closure)
                 (const Opentelemetry__Proto__Common__V1__InstrumentationLibrary *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor opentelemetry__proto__common__v1__string_key_value__descriptor;
extern const ProtobufCMessageDescriptor opentelemetry__proto__common__v1__instrumentation_library__descriptor;
