...
-- with above values, each and every containers running on the kubernetes will have a limit of 6000 logs for every 60 seconds since containers have unique kubernetes.docker_id value
