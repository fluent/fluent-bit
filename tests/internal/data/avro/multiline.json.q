[
  {
    ...
    "kubernetes": {
      ...
      "annotations": {
        ...
        "kubernetes.io/limit-ranger": "LimitRanger plugin set: cpu, memory request for container tensorboard; cpu, memory limit for container tensorboard; cpu, memory request for init container tokenfetcher; cpu, memory limit for init container tokenfetcher",
