...
static void load_parsers(struct flb_config *config)
{
    ...
    /*
     * no_year: the given format don't contain the Year, this is a common
     * case on old Syslog implementations.
     */
    p = flb_parser_create("no_year",                     /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%b %d %H:%M:%S",              /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /*
     * no_year_N: just for compatibility, check a string with no year
     * but including Nanoseconds.
     */
    p = flb_parser_create("no_year_N",                   /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%b %d %H:%M:%S.%L",           /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /* no_year_TZ: time string with no year and including timezone */
    p = flb_parser_create("no_year_TZ",                  /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%b %d %H:%M:%S %z",           /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /* no_year_N_TZ: time string with no year, nanoseconds and timezone */
    p = flb_parser_create("no_year_N_TZ",                /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%b %d %H:%M:%S.%L %z",        /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /* default_UTC: time string with timezone in UTC */
    p = flb_parser_create("default_UTC",                 /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%m/%d/%Y %H:%M:%S",           /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /* default_UTC: time string with timezone in UTC and ending Z */
    p = flb_parser_create("default_UTC_Z",               /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%m/%d/%Y %H:%M:%SZ",          /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /* default_UTC: time string with timezone in UTC and ending Z */
    p = flb_parser_create("default_UTC_N_Z",             /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%m/%d/%Y %H:%M:%S.%LZ",       /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    p = flb_parser_create("generic_TZ",                  /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%m/%d/%Y %H:%M:%S %z",        /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /* Generic date */
    p = flb_parser_create("generic",                     /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%m/%d/%Y %H:%M:%S",           /* time format */
                          "time",                        /* time key    */
    ...
    p = flb_parser_create("generic_N",                   /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%m/%d/%Y %H:%M:%S.%L"   ,     /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
    ...
    /* Generic date with nanoseconds and timezone */
    p = flb_parser_create("generic_N_TZ",                /* name        */
                          "json",                        /* format      */
                          NULL,                          /* regex rule  */
                          "%m/%d/%Y %H:%M:%S.%L %z",     /* time format */
                          "time",                        /* time key    */
                          NULL,                          /* time offset */
                          FLB_FALSE,                     /* time keep   */
                          NULL, 0,                       /* types (n/a) */
