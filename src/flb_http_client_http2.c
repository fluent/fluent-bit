...
//    struct flb_http_stream          *stream;
//
//    session = (struct flb_http2_client_session *) inner_user_data;
//
...
//    }
//
//    stream_id = session->parent->stream_sequence_number++;
//
...
//    }
//
//    cfl_list_add(&stream->_head, &session->parent->streams);
//
