                                                         ...
                                                         struct flb_tls *tls, int bypass_system_proxy)
{
    ...
    if (!bypass_system_proxy && flb_upstream_needs_proxy(host, config->http_proxy, config->no_proxy) == FLB_TRUE) {
...
/* Creates a new upstream context, bypasing the system proxy */
