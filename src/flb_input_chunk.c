                                  ...
                                  const void *buf, size_t buf_size)
{
     ...
     *
     * While shutting down there are two ways to keep appending anyway:
     *  - the plugin opted in with FLB_INPUT_SHUTDOWN_FLUSH (e.g. in_emitter).
     *  - ensure_threaded_flush_on_shutdown is enabled and this is a threaded
     *    input draining its ring buffer. Non-threaded inputs should still
     *    honor pause during shutdown.
     */
