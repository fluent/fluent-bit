...
#ifndef FLB_IN_PROMETHEUS_REMOTE_WRITE_PROT
#define FLB_IN_PROMETHEUS_REMOTE_WRITE_PROT
...
int in_prometheus_remote_write_prot_handle_error(struct flb_in_prometheus_remote_write *ctx,
                                                 struct in_prometheus_remote_write_conn *conn,
                                                 struct mk_http_session *session,
                                                 struct mk_http_request *request);
