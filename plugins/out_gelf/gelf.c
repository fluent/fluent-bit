...
static struct flb_config_map config_map[] = {
    {
     FLB_CONFIG_MAP_INT, "pckt_size", '1420',
     0, FLB_FALSE, offsetof(struct flb_out_gelf_config, pckt_size),
     NULL
    },
    {
     FLB_CONFIG_MAP_INT, "compress", FLB_TRUE,
     0, FLB_FALSE, offsetof(struct flb_out_gelf_config, compress),
     NULL
    },
    {
     FLB_CONFIG_MAP_INT, "seed", NULL,
     0, FLB_TRUE, offsetof(struct flb_out_gelf_config, seed),
     NULL
    },
    {
     FLB_CONFIG_MAP_INT, "mode", FLB_GELF_UDP,
     0, FLB_TRUE, offsetof(struct flb_out_gelf_config, mode),
     NULL
    },
