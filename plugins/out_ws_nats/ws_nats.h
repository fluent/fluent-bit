...
#ifndef FLB_OUT_WS_NATS
#define FLB_OUT_WS_NATS
...
#define NATS_CONNECT "CONNECT {\"verbose\":false,\"pedantic\":false,\"tls_required\":false,\"name\":\"fluent-bit\",\"lang\":\"C\",\"version\":\"0.1.0\"}\r\n"

struct flb_out_ws_nats {
    int out_format;
    char *uri;
    char *host;
    int port;
