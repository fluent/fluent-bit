...
static struct flb_config_map config_map[] = {
    {
     FLB_CONFIG_MAP_STR, "remote_host", "127.0.0.1",
     0, FLB_TRUE, offsetof(struct prom_remote_write_exporter, remote_host),
     "Address for the remote prometheus endpoint."
    },
    {
     FLB_CONFIG_MAP_INT, "remote_port", "80",
     0, FLB_TRUE, offsetof(struct prom_remote_write_exporter, remote_port),
     "TCP port for the remote prometheus endpoint."
    },
    /* EOF */
    {0}
};
...
struct flb_output_plugin out_prometheus_exporter_plugin = {
    .name        = "prometheus_remote_write_exporter",
    .description = "Prometheus remote write exporter",
