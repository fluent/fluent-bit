#ifndef TRACE_REGISTRY_H
#define TRACE_REGISTRY_H

#include <bpf/libbpf.h>

#include "generated/trace_signal.skel.h"
#include "generated/trace_execve.skel.h"

#include "signal/handler.h"  // Include signal handler
#include "execve/handler.h"  // Include execve handler
...
DEFINE_GET_BPF_OBJECT(trace_execve)

/* Trace table array - populated via REGISTER_TRACE */
static struct trace_registration trace_table[] = {
    REGISTER_TRACE(trace_signal, trace_signal_handler),
    REGISTER_TRACE(trace_execve, trace_execve_handler),
    {NULL, NULL, NULL, NULL, NULL, NULL}  // End of table marker
};

#endif // TRACE_REGISTRY_H
