...
#ifndef FLB_OUT_SCALEWAY_H
#define FLB_OUT_SCALEWAY_H
...
#define FLB_SCALEWAY_CT              "Content-Type"
#define FLB_SCALEWAY_CT_JSON         "application/json"
#define FLB_SCALEWAY_URI             "/loki/api/v1/push"
#define FLB_SCALEWAY_HOST            "api.scaleway.com"
#define FLB_SCALEWAY_PORT            443
#define FLB_SCALEWAY_HEADER_SCOPE    "X-Scope-OrgID"
#define FLB_SCALEWAY_HEADER_AUTH    "X-Auth-Token"

#define FLB_SCALEWAY_CREATE_URI      "/cockpit/v1/regions/fr-par/data-sources"


#define FLB_SCALEWAY_KV_STR    0     /* sds string */
#define FLB_SCALEWAY_KV_RA     1     /* record accessor */
#define FLB_SCALEWAY_KV_K8S    2     /* kubernetes label */

/* Output line format */
#define FLB_SCALEWAY_FMT_JSON  0
#define FLB_SCALEWAY_FMT_KV    1
...
int create_data_source(struct flb_output_instance *ins, const char *url, const char *auth_header, const char *project_id, const char *name, const char *type, char **created_url);
int create_push_url(struct flb_output_instance *ins, const char *data, char **push_url);
...
int setup_data_source(struct flb_output_instance *ins, const char *create_url, const char *project_id, const char *type, char **push_url,
                      int (*create_data_source)(struct flb_output_instance *, const char *, const char *, const char *, const char *, const char *, char **),
                      int (*fetch_and_create_url)(struct flb_output_instance *, const char *, const char *, const char *, char **));

char* generate_unique_name(const char *prefix);

void pack_string(msgpack_packer *pk, const char *key, const char *value);

struct flb_scaleway_kv {
    int val_type;                       /* FLB_SCALEWAY_KV_STR or FLB_SCALEWAY_KV_RA */
