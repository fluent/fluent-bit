...
#define opentelemetry__proto__collector__logs__v1__export_logs_service_response__field_descriptors NULL
#define opentelemetry__proto__collector__logs__v1__export_logs_service_response__field_indices_by_name NULL
#define opentelemetry__proto__collector__logs__v1__export_logs_service_response__number_ranges NULL
const ProtobufCMessageDescriptor opentelemetry__proto__collector__logs__v1__export_logs_service_response__descriptor =
{
  ...
  0,  opentelemetry__proto__collector__logs__v1__export_logs_service_response__number_ranges,
