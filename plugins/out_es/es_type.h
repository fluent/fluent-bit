 ...
 */
char* flb_es_str_copy_str(struct flb_es_str *dest, const char *src);
 ...
 *             @c value of dest is assigned NULL and NULL is returned.
 *
 * @return The value assigned to @c value of dest if src is not NULL and
 *         flb_sds_create succeeds, NULL otherwise.
 */
char* flb_es_sds_copy_str(struct flb_es_sds_t *dest, const char *src);
