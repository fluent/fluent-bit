...
static int in_splunk_pause(void *data, struct flb_config *config)
{
    struct flb_splunk *ctx;
...
static int in_splunk_resume(void *data, struct flb_config *config)
{
    struct flb_splunk *ctx;
...
struct flb_input_plugin in_splunk_plugin = {
    ...
    .cb_collect   = NULL,
    .cb_flush_buf = NULL,
    .cb_pause_checked = in_splunk_pause,
    .cb_resume_checked = in_splunk_resume,
