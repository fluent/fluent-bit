...
static struct flb_config_map config_map[] = {
    {
        ...
        0, FLB_TRUE, offsetof(struct flb_azure_kusto, tenant_id),
        "Set the tenant ID for authentication (required)"
    },
    {
        FLB_CONFIG_MAP_STR, "client_id", (char *)NULL,
        0, FLB_TRUE, offsetof(struct flb_azure_kusto, client_id),
        "Set the client/application ID for authentication (required)"
    },
    {
        FLB_CONFIG_MAP_STR, "client_secret", (char *)NULL,
        0, FLB_TRUE, offsetof(struct flb_azure_kusto, client_secret),
        "Set the client secret for authentication (required)"
    },
    {
        FLB_CONFIG_MAP_STR, "dce_uri", (char *)NULL,
        0, FLB_TRUE, offsetof(struct flb_azure_kusto, ingestion_endpoint),
        "Set Data Collection Endpoint(DCE) URI (required)"
    },
    {
        FLB_CONFIG_MAP_STR, "dcr_immutable_id", (char *)NULL,
        0, FLB_TRUE, offsetof(struct flb_azure_kusto, database_name),
        "Immutable ID for Data Collection Rule (DCR)"
    },
    {
        FLB_CONFIG_MAP_STR, "table_name", (char *)NULL,
        0, FLB_TRUE, offsetof(struct flb_azure_kusto, table_name),
        "Set the table name"
    },
