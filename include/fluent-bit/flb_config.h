...
struct flb_config {
    ...
    int   storage_pause_on_chunks_overlimit; /* flag to pause input when storage is full */
...
#define FLB_CONF_STORAGE_PAUSE_ON_CHUNKS_OVERLIMIT "storage.pause_on_chunks_overlimit"
